...
export const useModuleFilterReducer = (filters = DEFAULT_FILTERS) =>
  useReducer(moduleFilterReducer, filters);

/** Keep track of the filters and update non-undefined properties */
export function moduleFilterReducer(
  state: ModuleFilters,
  action: Partial<ModuleFilters>
): ModuleFilters {
